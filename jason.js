...
let fin = false;
let nbVictime;
let tabNoms = ["Jules", "Edgar", "Ilan", "Jarod", "Flore", "Aurélien", "Jean", "Iouli","Noémie","Eglantine","Mayeul","Lorenzo","Pierre","Gabriel","Allen","Thomas","Tom","Mathis","Anna","Julie","Margot","Adrien","Alfred","Lucile"];
let tabCara = ["Evadé de prison", "Joueur de Smash", "Pro du Kung-Fu","Depressif", "Amateur de Baudelaire", "Pratique l'évasion fiscale","Prof de SVT","Sait imiter le hibou","Consommateur de Doliprane","Administrateur Discord","Membre de la DGSE","Trésorier de Comedia Da Vinci","Président de la République","Bassiste d'un groupe pas ouf","Platiste"];
